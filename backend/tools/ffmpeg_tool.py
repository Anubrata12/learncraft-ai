...
def stitch_video(audio_path: str, slide_paths: List[str]) -> dict:
    """
    ...
    concat_file_path = os.path.join(output_dir, "input.txt")
    ...
    try:
        ...
        final_video_path = os.path.abspath(os.path.join(output_dir, "compiled_educational_video.mp4"))
